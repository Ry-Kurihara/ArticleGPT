...
<div class="t_b" style="font-weight:bold;margin-bottom:90px;margin-top:16px;color:{{comment.color|default('black')}};font-size:{{comment.size|default('18px')}};">{{comment.res}}
{%- if comment.item -%}
    {{ process_item(comment.item) }}
{%- endif -%}
</div><br/>
{%- endfor %}

<p style="color: gray; text-align: right;"><small>Quote: generated by earsoku.com a.i.（この記事はAIによる自動生成です）</small></p>
